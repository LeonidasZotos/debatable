...
def constructEmbeddings(mainArticleTitle, relatedArticlesContent, model):
    ...
    for relatedArticleContent in relatedArticlesContent:
        relatedArticlesEmbeddingsDict[relatedArticleContent] = model.encode(relatedArticleContent.title)
...
def filterArticles(mainArticleContent, relatedArticlesContent, model):
    ...
    mainTitleEmbedding, relatedArticlesEmbeddings = constructEmbeddings(mainArticleTitle, relatedArticlesContent, model)
